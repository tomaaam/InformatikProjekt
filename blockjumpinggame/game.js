...
// velocity the blocks move to the left(for not stopping them instantly rather using friction to come to a "soft" stop)
let blockvel = 0;
...
function update() {
    ...
    if (square.y > context.canvas.height - 30 - square.height) {
        handleGameOver();
    } // Call function to display the end screen
...
function render() {
    // Render any visual updates to the canvas
}
